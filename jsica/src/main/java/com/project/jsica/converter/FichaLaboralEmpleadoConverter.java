...
@FacesConverter(value = "fichaLaboralEmpleadoConverter")
public class FichaLaboralEmpleadoConverter implements Converter {

    @EJB
    private FichaLaboralEmpleadoFacadeLocal ejbFacade;
