 ...
 */
public abstract class BitacoraController<T> implements Serializable {
    ...
    public BitacoraController(Class<T> itemClass) {
        this.itemClass = itemClass;
    }

    public BitacoraController(Class<T> itemClass, Class controller) {
        this.itemClass = itemClass;
